...
_KNOWN_INERT_SETTINGS = {
    "APP_ENV", "APP_PORT", "APP_SECRET_KEY", "BACKTEST_DATA_PATH", "BACKTEST_MAX_WORKERS",
    "BACKTEST_RESULT_PATH", "CORS_ORIGINS", "GUIYI_AFTER_MARKET_ARCHIVE_ENABLED",
    "GUIYI_AFTER_MARKET_AUTOMATION_APPROVAL_HASH", "GUIYI_AFTER_MARKET_AUTOMATION_APPROVAL_PACKET",
    "GUIYI_AFTER_MARKET_AUTOMATION_ENABLED", "GUIYI_ALERT_NOTIFICATION_CONFIG_PATH",
    "GUIYI_DATA_CORE_V2_EOD_ENABLED", "GUIYI_DATA_CORE_V2_LIVE_DECISION_ENABLED",
    ...
    "GUIYI_LIVE_SIGNAL_EVENTS_ENABLED", "GUIYI_MARKET_HOME_PROJECTION_ENABLED",
    "GUIYI_SUBING_OBSERVATION_ROOT", "GUIYI_WECHAT_AUTOSEND_ENABLED", "LOG_FILE", "LOG_LEVEL",
    "POSTGRES_DB", "POSTGRES_PORT", "POSTGRES_USER", "QYWX_WEBHOOK_URL", "REDIS_PORT",
    "RISK_MAX_DAILY_LOSS", "RISK_MAX_DRAWDOWN", "RISK_MAX_POSITION_RATIO", "RQDATA_ADDR",
    "RQDATA_LICENSE_KEY", "RQDATA_PASSWORD", "RQDATA_USERNAME", "VITE_API_BASE_URL",
    "VITE_MARKET_WS_URL", "VITE_PROXY_API_TARGET", "VITE_PROXY_WS_TARGET", "VITE_WS_URL",
}
...
class RuntimeDataBinding:
    ...
    def __init__(self, root: Path, commit: str, status_sha256: str):
        ...
        self._validate_age()
        parsed_settings = literal_settings(self._sources[self.config_path][0])
        if parsed_settings.keys() - _DEPENDENCY_SETTINGS - _KNOWN_INERT_SETTINGS:
            raise ValueError
