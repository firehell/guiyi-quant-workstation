...
- T3-real：provider readiness 解阻代码已完成，2026-07-20 官方 watermark 只读 smoke 显示 daybar 16:00:11、minbar 16:18:37 ready；合并主干后端全量 `1110 passed, 3 skipped`。仍需先将 historical/Profile 追平至最新关闭日，再在 JM 可交易时段使用新 hash packet 执行 live 表/checkpoint 写入。
