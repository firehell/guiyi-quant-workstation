...
| `v1.10.0` Release candidate | `codex/release-v1.10.0` 基于 `origin/develop@72483c46854016b544684fe15b6d7ce964681f09` 准备候选，包含 Newow 白色详情 V2、Market Home light 与默认关闭的 Live recovery 能力，并记录已验证的仓库外 SuBing 60/60 physical 15m 历史输入状态；尚未完成本轮全量验证、main 合入、annotated tag、GitHub Release 或 Runtime promotion。 |
