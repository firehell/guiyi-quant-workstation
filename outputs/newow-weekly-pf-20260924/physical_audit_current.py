...
R=Path('/Volumes/扩展盘/guiyi-quant-workstation');P=Path('/Volumes/扩展盘/guiyi-quant-workstation/outputs/newow-weekly-pf-20260924')
...
ps=('pf',);cut=datetime.fromisoformat(old['as_of']);targets={}
