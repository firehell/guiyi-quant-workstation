...
R=Path('/Volumes/扩展盘/guiyi-quant-workstation');P=Path('/Volumes/扩展盘/guiyi-quant-workstation/outputs/newow-weekly-remaining10-20260924')
...
ps=('pf','pk','pl','pr','px','rs','sf','sh','sm','sr');cut=datetime.fromisoformat(old['as_of']);targets={}
...
try:
 ...
 result={'code_sha':'55454558629734aff0856d02692c1d4242500980','as_of':str(cut),'products':ps,'scope':'contracts enumerated by 20260923 fixed-cutoff prior native audit, maximum owner through per contract','catalog_revision':rev,'revision_stable':rev==after==fresh,'readonly':True,'provider_requests':0,'writes':0,'contracts':out}
