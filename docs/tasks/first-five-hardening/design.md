...
日期：2026-09-17。状态：设计提案，尚未实施；本文件不授予生产写入、发布或 Runtime 切换权限。
...
本轮独立工作树为 `/Volumes/扩展盘/guiyi-quant-workstation/.worktrees/first-five-design`，分支 `codex/first-five-design`，起点为 `develop@78515dff718a787f8e11693545114f83682f32ce`。主工作树已有未跟踪文档与 outputs，均保留。本轮只有设计文档改动。
