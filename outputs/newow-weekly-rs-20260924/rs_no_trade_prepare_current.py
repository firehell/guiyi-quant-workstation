...
BASE = Path("outputs/newow-weekly-remaining10-20260924")
...
def main() -> None:
    snapshot = json.loads((BASE / "physical-causes.json").read_text())
    ...
    try:
        ...
        packet = {
            ...
            "code_sha": "09482651c9cad177ab04bd1e4e9c4df004de7ca0",
            "catalog_revision": before,
            "canonical_root_sha256": root_identity["canonical_root_sha256"],
            "project_env_sha256": root_identity["config_sha256"],
            "aggregation_version": WEEKLY_AGGREGATION_VERSION,
            "aggregation_source_sha256": sha(Path(rqdata_adapter.__file__).read_bytes()),
            "source_sha256": sha(Path(__file__).read_bytes()),
            "repair_source_sha256": sha((SOURCE_DIR / "rs_repair_batch.py").read_bytes()),
