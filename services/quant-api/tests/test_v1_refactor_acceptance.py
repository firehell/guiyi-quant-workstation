        ...
        trades=[
            {
                ...
                "volume": 1,
                "gross_pnl": Decimal("5012.0"),
                "commission": Decimal("8.0"),
                "slippage": Decimal("4.0"),
                "net_pnl": Decimal("5000.0"),
            },
            {
                "trade_id": "T2",
                "datetime": datetime(2024, 1, 2, 10, 0),
                "price": Decimal("3490.5"),
                "volume": 1,
                "gross_pnl": Decimal("-1493.5"),
                "commission": Decimal("4.5"),
                "slippage": Decimal("2.0"),
                "net_pnl": Decimal("-1500.0"),
            },
        ],
...
def test_v1_backtest_api_report_endpoints_are_serializable() -> None:
    ...
    with SessionLocal() as session:
        ...
        report = BacktestReportModel(
            ...
            research_only=False,
            status="success",
            summary={"initial_capital": 100000.0, "final_equity": 100196.0, "total_return": 0.00196, "max_drawdown": 0.0},
            warnings=[],
        )
        session.add(report)
        session.flush()
