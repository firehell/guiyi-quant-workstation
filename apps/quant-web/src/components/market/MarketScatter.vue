...
<style scoped>
.market-scatter { position: relative; padding: 16px; min-height: 300px; border: .5px solid var(--gy-border); border-radius: var(--gy-radius-lg); background: var(--gy-bg-panel); box-shadow: var(--gy-shadow-panel); overflow: hidden; }.market-scatter header span { color: var(--gy-text-muted); font-size: var(--gy-font-size-xs); }.market-scatter h2 { margin: 3px 0 0; font-size: var(--gy-font-size-md); }
.market-scatter__plot { position: relative; height: 220px; margin-top: 18px; border: 1px solid var(--gy-border); background: linear-gradient(90deg, transparent 49.8%, var(--gy-border) 50%, transparent 50.2%), linear-gradient(transparent 49.8%, var(--gy-border) 50%, transparent 50.2%), var(--gy-bg-app); }.market-scatter__point { position: absolute; transform: translate(-50%, -50%); padding: 0; border: 2px solid #ffffff; border-radius: 50%; background: var(--gy-accent); cursor: pointer; box-shadow: 0 0 0 1px var(--gy-border-strong); }.market-scatter__point:hover { background: var(--gy-accent-hover); }.market-scatter__plot p { margin: 0; padding: 96px 16px; text-align: center; color: var(--gy-text-muted); }
