...
from app.market_data.actual_dominant_research import ActualDominantResearchSegmentIdentityError
...
from app.research.n_structure.n_candidate_validation import NStructureCandidateValidationReport
