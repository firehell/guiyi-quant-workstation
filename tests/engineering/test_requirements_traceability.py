...
TRACEABILITY: dict[str, tuple[str, ...]] = {
    ...
    "4.3": (
        "tests/engineering/test_personal_collaboration_properties.py",
        "tests/engineering/test_scripts_cli_final_layout.py",
    ),
    ...
    "11.3": ("services/quant-api/tests/test_notification_worker.py",),
    "11.4": (
        "services/quant-api/tests/test_live_review_loop_eod_sample_retention.py",
    ...
    "11.6": (
        "services/quant-api/tests/test_after_market_automation.py",
        "tests/engineering/test_personal_canonical_consistency.py",
    ),
    "11.7": (
        "services/quant-api/tests/test_live_review_loop_api_and_event_gate.py",
    ...
    "11.8": ("services/quant-api/tests/test_htdy_first_seen_events.py",),
    "11.9": (
        "services/quant-api/tests/test_after_market_real_acceptance.py",
        "tests/engineering/test_personal_canonical_consistency.py",
    ),
    ...
    "12.10": (
        ...
        "services/quant-api/tests/test_live_review_loop_eod_sample_retention.py",
        "services/quant-api/tests/test_data_sources.py",
        "tests/engineering/test_personal_workflow.py",
    ),
