...
| `v1.10.1` Release candidate | `codex/release-v1.10.1` 基于 `origin/develop@5e2b76ae029689145340c20d59ef414a543554cb` 准备候选，包含 Newow MDS 缺失映射的 typed `NEWOW_DATA_UNAVAILABLE / HTTP 409`、限定 `1m → 60m` 物理合约 warm-up 与已验证 rb 60m 请求事实文档。发布矩阵已通过：backend `2394 passed, 5 skipped, 15 deselected`、Mypy 134 个源文件、Ruff、engineering `74 passed`、OpenSpec `9/9`、secret scan `0`、Web `467 passed, 1 skipped`、build/topology 与 Playwright `140 passed`；对齐 `origin/main@f8f7d917...` 后的 focused 验证为 backend `181 passed`、engineering `74 passed`、OpenSpec `9/9`、secret scan `0`、Web `467 passed, 1 skipped` 与 build/topology 通过。独立 Standards 与 Spec Review 均为 PASS、0 findings；尚未完成 main 合入、annotated tag、GitHub Release 或 Runtime promotion。 |
