...
const displayFacts = computed(() => props.facts)
</script>
...
<style scoped>
.detail-fact-strip { display: grid; grid-template-columns: repeat(auto-fit, minmax(min(100%, 210px), 1fr)); gap: var(--gy-space-2); margin: 0; padding: var(--gy-space-4) 0; }
