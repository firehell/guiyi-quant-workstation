...
| `v1.10.0` Release candidate | `codex/release-v1.10.0` 基于 `origin/develop@72483c46854016b544684fe15b6d7ce964681f09` 准备候选，包含 Newow 白色详情 V2、Market Home light、SuBing 60/60 physical 15m 历史输入与默认关闭的 Live recovery 能力；尚未完成本轮全量验证、main 合入、annotated tag、GitHub Release 或 Runtime promotion。 |
