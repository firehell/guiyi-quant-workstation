...
OLD=P.parent/'2026-09-09'/'analysis.json'
...
a['recheck_unavailable']=recheck_unavailable;a['previous_total']=prev['total'];a['previous_cutoff']=prev['cutoff'];a['status']='PARTIAL' if any(m['errors'] or m.get('missing_count',0) for m in market.values()) else 'COMPLETED'
