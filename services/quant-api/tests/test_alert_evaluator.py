...
def test_subing_evaluator_replays_only_current_contract_and_uses_incremental_cursor() -> None:
    window = _window(80)
    next_window = _window(81)
    replay_bars = tuple(_bar(index) for index in range(81))
