...
当前核对为 **2026-09-26**：详情v3.3.59、首页v3.3.65、选股页v3.2.103。

- [最新版完整功能、差异与期货适配待办](AUDIT_20260926.md)
- [原版公开公式附册](FORMULA_CATALOG_20260926.md)
- [手册总入口](REPLICATION_MANUAL.md)

下面完整保留9月18日历史审计。其“正式仅1d”“趋势转折未实现”等判断只指当时；当前代码已有1d/1w能力及趋势转折/专用副图。旧测试和样本不转写为本轮最新验收。

<a id="historical-20260918"></a>

# 2026-09-18 历史算法与 AI 分析审计
