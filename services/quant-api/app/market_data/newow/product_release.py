...
CAPABILITY_SCHEMA_VERSION: Literal["newow_product_capabilities_v19"] = (
...
FORMAL_WEEKLY_V2_PRODUCTS = ("b", "bz", "cj", "eb", "eg", "j", "oi", "pf", "pg", "pk", "pl", "pr", "px", "rs", "si", "sr")
...
if (
    len(OPEN_WEEKLY_PRODUCTS) != 57
    or len(REMAINING_WEEKLY_V2_PRODUCTS) != 3
    or len(FORMAL_WEEKLY_V2_PRODUCTS) != 16
