...
def build_request(args: argparse.Namespace):
    ...
    if args.data_command in {"after-market", "weekly-audit", "close-interrupted-after-market", "daily-recovery", "session-anchor-repair", "metadata-repair", "au-calendar-correction"}:
        return None
