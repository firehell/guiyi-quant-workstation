...
| 回测　　　　　　　　　　　　　　 | 旧 backtest API/Web/worker/queue/CLI、OOS/报告 evidence 与兼容入口退役；未来如需回测，以新任务基于 Canonical/MarketDataService 重建　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　 | 新合同仍须保证策略/参数/数据/订单/trade/equity/lineage 可复算、可信度优先于收益；不得恢复旧入口　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　|
...
| V2 迁移资产　　　　　　　　　　　| 只迁移 trusted historical bars 及最小 Catalog/Manifest/Gap/MainContractMap metadata　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　 | 旧 indicator/cache、Backtest、Signal/Review、live/EOD/Sample、permanent derived period、重复 bar layer 与 Profile/Binding/legacy lineage 均不得提升为 active migration asset；backtest 不保留 compatibility |
...
| 旧 S6 控制面　　　　　　　　　　 | S6-08/S6-09/S6-10 packet、mapping、deployment、stability 与 Runtime scheduler 控制面退役　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　 | 历史事实只由 Git 追溯，不生成新 packet/receipt/daily child，不提供恢复入口，也不改变 Task 06、盘后 scheduler、default-off/no-order 边界　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　　|
...
- `docs/tasks/GY-DATA-CORE-V2.md` 是当前数据交互收口的 active 业务合同；已删除的 `GY-CORE-CONVERGENCE.md` 等旧路线快照仅作 Git-history historical fact，不再作为现存路径或授权来源。
...
未来涉及产品边界、数据、重建回测、live/通知或个人开发/发布模型的长期变化，先在此处或对应 deep canonical 固化；普通实现细节不新增 ADR。
