...
| Stage 6 JM historical continuity | S6-03 使用 provider-final trading day、create-only version、exact passed quality 和 Profile CAS；当前 target=`2026-07-17`、actual=`JM2609` | 三个 S6-03 Gate 已通过；后续 S6-04 已关闭 context，不自动进入 T3/T4 |
| Stage 6 JM live context | S6-04 固定使用 current actual-contract passed historical warm-up + latest live trading day confirmed/passed bars；previous DCE trading day freshness、exact duplicate historical-first、OHLCV conflict fail-closed | `JM_LIVE_CONTEXT_READY`；下一步 S6-05 T3，不写 SignalEvent/notification，不修改策略 |
...
- 阶段 4/5 已关闭；Stage 6 S6-03 historical/reference/live-target freshness 与 S6-04 historical/live context 已通过，下一步为 S6-05 T3。T3/T4、SignalEvent、企业微信真实发送和 long-running 仍须独立审批。
