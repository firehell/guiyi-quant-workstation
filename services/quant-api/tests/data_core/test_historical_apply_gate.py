...
def test_progress_accepts_actual_minute_run_spanning_multiple_daily_sessions() -> None:
    dataset = {
        "provider": "rqdata",
        "dataset_kind": "actual_dominant",
        "symbol": "jm",
    ...
    session_windows = [
        {
            "trading_day": "2023-01-03",
            "start": "2023-01-02T13:00:00+00:00",
            "end": "2023-01-02T15:30:00+00:00",
        },
        {
            "trading_day": "2023-01-03",
            "start": "2023-01-03T01:00:00+00:00",
            "end": "2023-01-03T03:30:00+00:00",
        },
        {
            "trading_day": "2023-01-03",
            "start": "2023-01-03T05:30:00+00:00",
            "end": "2023-01-03T07:00:00+00:00",
        },
    ]
    mapping_windows = [
        [item["start"], item["end"]]
    ...
    write_plans = [{
        "dataset": dataset,
        "mapping_valid_windows": mapping_windows,
        "execution_runs": [[
