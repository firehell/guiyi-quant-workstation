...
`DATA_ASSET_PROFILE_ACCEPTANCE_BLOCKED`
...
- historical/live boundary violations: `395`
...
- Profile blocked reasons: `{"checksum_missing|lineage_unverified|missing": 9, "checksum_not_verified": 1, "conflicting_duplicate_candidates": 2, "lineage_unverified": 685, "lineage_unverified|partial": 1, "mapping_date_missing": 1015, "partial": 1, "quality_policy_violation": 45, "roll_transition": 39, "target_coverage_incomplete": 118}`
...
阶段 C 仍需独立验证 Market / Backtest / Signal consumer contract。本报告禁止使用 `DATA_LAYER_READY_FOR_MARKET_BACKTEST_SIGNAL` 状态。
