...
<template>
  <div class="market-dashboard-page">
    ...
    <section class="market-home-main">
      ...
      <MarketHomeTrustStrip :target-as-of="home.overview.data.value?.target_as_of ?? null" :as-of="home.overview.data.value?.data_as_of ?? null" :participants="home.overview.data.value?.participant_count ?? null" :active="home.overview.data.value?.active_count ?? null" :stale-count="home.overview.data.value?.stale_count ?? null" :unavailable-count="home.overview.data.value?.unavailable_count ?? null" :price-unavailable-count="home.overview.data.value?.summary.price_unavailable_count ?? null" :overview="model.overview.availability" :runtime="model.runtime.status" :event-state="model.events.availability" :overview-stale="model.overview.cachedStale" :runtime-stale="model.runtime.cachedStale" :event-stale="model.events.cachedStale" :overview-error="home.overview.error.value ?? null" />
