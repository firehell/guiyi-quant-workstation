"""Run OI's three W1 consumers against a read-only, in-memory candidate overlay."""
...
from scripts.oi_weekly_local_rebuild import prepare, CUTOFF
...
with Session(engine, autoflush=False) as session:
    ...
    by_path = {}
    synthetic = []
    key = DatasetKey("contract", "oi", "OI2611", "1w")
