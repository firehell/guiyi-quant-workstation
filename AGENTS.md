...
canary/send、Scope 变更或 Runtime promotion/switch。未来启用前必须分别完成 Topic 四人加入人工核对、
Git 外配置、owner canary、HTDY Topic canary、精确 bounded authorization、release 与 Runtime switch。
