...
- audit_time: `2026-07-12T16:13:16.456705+00:00`
- git_commit: `64b682086f240e35cc2642c501beaeaa03bf1cdf`
- audit_end: `2026-07-10`
- data_root: `/Volumes/扩展盘/guiyi-quant-workstation/data`
- db_snapshot_source: `database`
- db_snapshot_time: `2026-07-12T16:04:40.584320+00:00`
- products: `90`
...
| 全品种已经下载2020年至今的1d数据 | partial | passed_or_warning=491/546 |
| 全品种已经下载2020年至今的1w数据 | partial | products_full_post2020=70/90 |
| 全品种从上市以来到2019年末的1w数据也已经下载 | rejected | pre2020_covered=29/63 |
| 全品种1w候选覆盖范围为上市以来至最新完成周 | confirmed | direct_1w_present=90/90; audit_end=2026-07-10 |
| 已下载主连、历史主力真实合约及相关附加数据 | rejected | dominant_main_passed=0/90; actual_contract_passed=1199/1244 |

## Legacy Metric Re-check

- stage8_6 product active_passed / active_partial: `0` / `90`
- stage8_6 asset active_passed / audit_pending: `1199` / `135`
