...
actual_dominant 共 21 组同窗口读回全部通过。生产正式分区现为 4,553 个，数据资产与完整闭环验收均为
9/60，剩余 51 个 active 品种待重建。60 品种重建及全域 Canonical 验收仍未完成。
...
Parquet 均可读，且七周期三种查询模式的早期、最近与跨换月共 21 组读回通过。其余 51 个品种的历史
