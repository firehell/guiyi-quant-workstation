...
export interface NewowProductCapabilities {
  readonly schema_version: 'newow_product_capabilities_v3' | 'newow_product_capabilities_v4' | 'newow_product_capabilities_v5' | 'newow_product_capabilities_v6' | 'newow_product_capabilities_v7' | 'newow_product_capabilities_v8' | 'newow_product_capabilities_v9' | 'newow_product_capabilities_v10' | 'newow_product_capabilities_v11'
...
export interface NewowDailySnapshot {
  readonly schema_version: 'newow_daily_snapshot_v1'
  readonly product: string
  readonly strategy: NewowProductStrategy
  readonly frequency: '1d'
  readonly series_kind: 'actual_dominant'
  readonly requested_at: string
  readonly expected_trading_day: string
  readonly available_trading_day: string
  readonly as_of: string
