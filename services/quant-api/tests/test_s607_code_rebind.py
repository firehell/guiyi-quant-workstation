...
def test_code_rebind_accepts_parent_bound_schema_v5_deployment_receipt(
    tmp_path,
) -> None:
    import hashlib
    import json
    ...
    receipt = {
        "schema_version": 1,
        "task_id": "JM-LIVE-STABILITY-S6-10",
        "receipt_type": "htdy_s6_10_schema_v5_code_only_deployment",
        "status": "completed",
        "approval_packet_hash": "2" * 64,
    ...
    parent["bindings"]["s6_07_rebind_packet_sha256"] = "5" * 64
    with pytest.raises(RuntimeError, match="deployment_receipt_invalid"):
        validate_deployment_receipt(
            packet,
            receipt,
            authorization_parent=parent,
