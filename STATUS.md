...
| `v1.10.2` Release candidate | `codex/release-v1.10.2` 基于 `origin/develop@d34819140126375d7c868a7010f96f13dec249c3`，并以 merge commit `346114eaae6d6f7948fd89bad3209015d9c28a77` 对齐 `origin/main@8e3df5c0bf6ced6712f76941bcf08065f1015188`；版本候选 `8e79bfcfc03793c2b090e1c67b31ffdfef4fbcc9` 将 API/Web 身份推进为 `1.10.2`。该候选包含 Market Home 四桶涨跌汇总与 nullable `price_change_1d` 透明展示 P0；未修改 RS 零值 D1 Canonical、MainContractMap、Scope、Runtime 或通知。发布矩阵已通过，最终独立 Review 尚待完成；main 合入、annotated tag、GitHub Release 与 Runtime promotion 均未执行。 |
