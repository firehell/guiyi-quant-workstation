...
- 精确计划：[prepare.json](prepare.json)，SHA-256 `b24538a34ab2e7cce3bad56b7c1421dd0236d48ffe307689006ed3ec243dcd63`。计划记录聚合版本及源码 hash、10 个 D1 原分区 hash、37 个交易周端点及聚合值、10 个 W1 原/候选分区身份与目标 URI。首次执行前必须重新比对整个计划；身份漂移则废弃旧包。
