...
R=Path('/Volumes/扩展盘/guiyi-quant-workstation');P=Path('/Volumes/扩展盘/guiyi-quant-workstation/outputs/newow-weekly-pk-20260924')
...
ps=('pk',);cut=datetime.fromisoformat(old['as_of']);targets={}
