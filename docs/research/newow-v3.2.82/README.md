...
本目录沿用v3.2.82历史名称，持续保存公开页面观察、公式整理、股票逐值对照、期货适配和截图证据。最新核对日期2026-09-26：详情v3.3.59、首页v3.3.65、选股页v3.2.103。用途是研究、复算和产品设计。
...
- **[2026-09-26 功能、差异与期货适配](AUDIT_20260926.md)**：先读此文。分类登记优化、新算法/UI、已实现但待验证、未知和不迁入范围。
- **[原版公开公式附册](FORMULA_CATALOG_20260926.md)**：集中数学式、阈值、初始化、同根顺序、统计口径和来源；此卷不掺期货修正。
- [当前审计入口及9月18日历史审计](CURRENT_AUDIT.md)
...
本节只指冻结v3.2.82证据，不代表最新详情已全部复刻。当前代码和未完成项见[2026-09-26审计](AUDIT_20260926.md)；趋势转折与专用副图已合入，不再沿用旧“未实现”结论。
