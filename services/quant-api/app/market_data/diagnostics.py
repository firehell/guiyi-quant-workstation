...
DATA_REASONS = MISSING_REASONS | INTEGRITY_REASONS | {
    "SOURCE_NONPOSITIVE_PRICE", "SOURCE_QUALITY_CLASSIFICATION_UNSUPPORTED",
}
...
_SOURCE_REASONS = {
    **{reason: reason for reason in MISSING_REASONS},
    ...
    "WEEKLY_SOURCE_BAR_CONFLICT": "DATA_INTEGRITY_INVALID",
    "SOURCE_QUALITY_CLASSIFICATION_UNSUPPORTED": "SOURCE_QUALITY_CLASSIFICATION_UNSUPPORTED",
}
