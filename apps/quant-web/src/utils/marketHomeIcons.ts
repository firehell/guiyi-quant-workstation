export type MarketHomeIconState = 'up' | 'aligned' | 'down' | 'neutral' | 'mixed' | 'unavailable'
...
export const MARKET_HOME_ICON_GLYPHS = {
  ...
  mixed: 'M6.5 8.5h4l-2-2m2 2-2 2m1.5 5h-3.5m3.5 0-2-2m2 2-2 2m4-5h3.5m-3.5 0 2-2m-2 2 2 2',
