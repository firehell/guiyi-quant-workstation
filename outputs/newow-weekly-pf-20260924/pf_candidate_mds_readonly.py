"""Preview the full PF candidate through real MDS with in-memory W1 pointers."""
...
class OverlayCatalog:
    ...
    def all_partitions(self, key):
        ...
        if key.symbol != "pf" or key.frequency.value != "1w":
            return old
...
def main():
    ...
    try:
        ...
        print(json.dumps({"status": "passed", "mode": "read_only_in_memory_overlay",
                          ...
                          "quality_interruptions": 84, "contracts_checked": 40,
