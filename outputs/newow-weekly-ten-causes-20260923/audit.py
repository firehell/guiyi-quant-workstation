...
R=Path('/private/tmp/guiyi-w1-ten-causes-20260923/code');P=Path('/Volumes/扩展盘/guiyi-quant-workstation/outputs/newow-weekly-ten-causes-20260923')
...
BASE=Path('/Volumes/扩展盘/guiyi-quant-workstation/outputs/newow-weekly-remaining12-20260923');old=json.loads((BASE/'readiness-full.json').read_text())
ps=('oi','pf','pk','pl','pr','px','rs','sf','sh','sm');cut=datetime.fromisoformat(old['as_of']);targets={}
...
try:
 ...
 result={'code_sha':'05a3647f5368c1f8882f665342f24abb4f9fecc9','as_of':str(cut),'products':ps,'scope':'contracts enumerated by 20260923 fixed-cutoff prior native audit, maximum owner through per contract','catalog_revision':rev,'revision_stable':rev==after==fresh,'readonly':True,'provider_requests':0,'writes':0,'contracts':out}
