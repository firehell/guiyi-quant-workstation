...
ROOT=Path('/private/tmp/guiyi-w1-r12-audit-20260923/code')
OUT=Path('/Volumes/扩展盘/guiyi-quant-workstation/outputs/newow-weekly-remaining12-20260923')
...
PRODUCTS=('cj','oi','pf','pk','pl','pr','px','rs','sf','sh','sm','sr')
SHA='6423d85131e1f0ae3855bd7096c911d795461556'
def save(name,x):
