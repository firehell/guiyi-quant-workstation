...
def test_formal_sr_weekly_scope_uses_v2_and_keeps_other_three_closed():
...
def test_formal_pk_weekly_scope_uses_v2_and_keeps_other_three_closed():
...
def test_formal_pf_weekly_scope_uses_v2_and_keeps_other_three_closed():
...
def test_formal_pl_weekly_scope_uses_v2_and_keeps_other_three_closed():
...
def test_formal_pr_weekly_scope_uses_v2_and_keeps_other_three_closed():
...
def test_formal_px_weekly_scope_uses_v2_and_keeps_other_three_closed():
    ...
    try:
        with TestClient(app) as client:
            response = client.get(
                ...
                params={"product": "sf", "strategy": "trend", "frequency": "1w"},
            )
    finally:
        app.dependency_overrides.clear()
