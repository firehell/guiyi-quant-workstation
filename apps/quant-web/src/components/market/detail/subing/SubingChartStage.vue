...
const emit = defineEmits<{ 'load-earlier': []; 'focus-resolved': [focusBarEnd: string]; 'marker-select': [marker: KlineMarker]; 'reference-select': [id: string] }>()
...
<template>
  <MarketKlineStage
    ...
    :reference-callouts="referenceCallouts" :reference-selection="referenceSelection" :focus-request-id="focusRequestId" @reference-select="emit('reference-select', $event)"
