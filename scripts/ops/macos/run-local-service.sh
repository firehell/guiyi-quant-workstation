...
LAUNCHER_ALERT_CLAWBOT_OWNER_PATH="${GUIYI_ALERT_CLAWBOT_OWNER_PATH:-}"
...
[[ -z "$LAUNCHER_ALERT_CLAWBOT_OWNER_PATH" ]] || export GUIYI_ALERT_CLAWBOT_OWNER_PATH="$LAUNCHER_ALERT_CLAWBOT_OWNER_PATH"
